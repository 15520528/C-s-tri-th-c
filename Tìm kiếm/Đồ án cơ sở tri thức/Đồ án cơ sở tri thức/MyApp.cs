    ...
    public partial class MyApp : Form
    {
        ...
        public  void KhoiTaoThongTin()// Khởi tạo Dictionary Information gồm TenDienThoai,ThongTinDienThoai
        {
            ...
            for (var i = 0; i < PhoneList.Count(); i++)
            {
                ...
                ThongTin = ThongTin + " " + PhoneList[i].MangDiDong.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].Sim.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].Wifi.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].GPS.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].Bluetooth.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].CongKetNoi_Sac.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].JackTaiNghe.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].KetNoiKhac.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].ChatLieu.ToString(); 
                ...
                ThongTin = ThongTin + " " + PhoneList[i].CongNghePin.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].BaoMatNangCao.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].TinhNangDacBiet.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].GhiAm.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].Radio.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].XemPhim.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].NgheNhac.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].ThoiDiemRaMat.ToString();
                ThongTin = ThongTin + " " + PhoneList[i].MauSac.ToString();
        ...
        //    Results = KetQuaTimKiem("kHáng     nokia ");
